...
/* SPM2 Debug Features */
#define SPM2_WDT_LATCH0     (0x11015000 + 0x190)
#define SPM2_WDT_LATCH1     (0x11015000 + 0x194)
#define SPM2_WDT_LATCH2     (0x11015000 + 0x198)
...
#define HVFS_SRAM_ADDRESS 0x0012a000
#define HVFS_SRAM_LENGTH  0x3000	/* 12K bytes */
