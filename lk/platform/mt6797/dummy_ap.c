...
void pmic_init_sequence(void)
{
	...
	if (pmic_get_register_value(MT6351_PMIC_HWCID) == 0x5140) {
		...
		dprintf(CRITICAL, "[PMIC] 6351 VOW 0x%x, 0x%x, 0x%x 0x%x\n", pmic_get_register_value(MT6351_PMIC_HWCID),
						pmic_get_register_value(MT6351_PMIC_RG_VOWEN_MODE),
						pmic_get_register_value(MT6351_PMIC_RG_SRCVOLTEN_MODE),
						pmic_get_register_value(MT6351_PMIC_BUCK_VSRAM_PROC_VOSEL_CTRL));
	}
	if (pmic_get_register_value(MT6351_PMIC_HWCID) == 0x5120) {
		dprintf(CRITICAL, "[PMIC] 6351 VOW 0x%x, 0x%x, 0x%x 0x%x\n", pmic_get_register_value(MT6351_PMIC_HWCID),
						pmic_get_register_value(MT6351_PMIC_RG_VOWEN_MODE),
						pmic_get_register_value(MT6351_PMIC_RG_SRCVOLTEN_MODE),
						pmic_get_register_value(MT6351_PMIC_BUCK_VSRAM_PROC_VOSEL_CTRL));
