...
void rdma_dump_analysis(DISP_MODULE_ENUM module)
{
	...
	DDPMSG("rdma%d:en=%d,w=%d,h=%d,pitch=%d,addr=0x%x,fmt=%s,fifo_min=%d,in(%d,%d),out(%d,%d)\n",
	       idx,
