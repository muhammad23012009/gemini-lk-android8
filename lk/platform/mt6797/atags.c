...
unsigned *target_atag_videolfb(unsigned *ptr, size_t buf_size)
{
	...
	/*
	 * mt_disp_get_lcd_time() will detect the fps and update
	 * the result of lcm_is_connected. Thus mt_disp_get_lcd_time() should
	 * be called before DISP_IsLcmFound() in case that DISP_IsLcmFound()
	 * gets the wrong detection result.
	 */
