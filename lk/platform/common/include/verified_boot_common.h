...
extern int sec_query_warranty(int *warranty);
extern int sec_boot_check(int try_lock);
extern int sec_is_in_factory(int *in_factory);
extern struct vb_part_name_map vb_part_name_map_table[MAP_VB_PART_NUM];
