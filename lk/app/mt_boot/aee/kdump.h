...
int kdump_null_output(const struct mrdump_control_block *kparams, const struct kzip_memlist *memlist);
...
int mrdump_vfat_output(const struct mrdump_control_block *mrdump_cb, const struct kzip_memlist *memlist, struct mrdump_dev *mrdump_dev);

void kdump_core_header_init(const struct mrdump_control_block *kparams, const struct kzip_memlist *memlist);
void kdump_core32_header_init(const struct mrdump_control_block *kparams, const struct kzip_memlist *memlist);
void kdump_core64_header_init(const struct mrdump_control_block *kparams, const struct kzip_memlist *memlist);
