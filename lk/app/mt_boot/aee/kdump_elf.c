...
void kdump_core32_header_init(const struct mrdump_control_block *mrdump_cb, const struct kzip_memlist *memlist)
{
	...
	mrdump_elf_setup_elfhdr(elf, EM_AARCH64, struct elf32_hdr, struct elf32_phdr, i);
