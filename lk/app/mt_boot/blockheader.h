...
#define HEADER_BLOCK_SIZE                 (4096)    // 4KB 0x1000
#define HEADER_IDENTIFIER                 ("UFS_BOOT")
#elif defined(MTK_EMMC_SUPPORT)
#define HEADER_BLOCK_SIZE                 (2048)    // 2KB 0x800
#define HEADER_IDENTIFIER                 ("EMMC_BOOT")
#else
#define HEADER_BLOCK_SIZE                 (2048)    // 2KB 0x800
#define HEADER_IDENTIFIER                 ("NAND_BOOT")
#endif
